...
impl Stream {
    ...
    pub fn connect_tcp(
        ...
        #[cfg(any(target_os = "linux", target_os = "macos",))] tcp_keepalive_probe_interval_secs: Option<u32>,
        #[cfg(any(target_os = "linux", target_os = "macos",))] tcp_keepalive_probe_count: Option<u32>,
